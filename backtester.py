...
import config
from support import *
from datafeeds.datafeed import LobDataFeed, LobModelFeed,PandasDataFeed,BaseDataFeed,PandasNamespace
from recorders.observer import LobObserver
...
class BackTester(BaseTester):
    ...
    def add_market_data(self, data:Union[PandasDataFeed,LobDataFeed,BaseDataFeed]):
