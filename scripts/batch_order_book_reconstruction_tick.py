...
if __name__ == '__main__':
    ...
    for stk_name in stks[skip:limit]:
        ...
        # [2022-01-01_2022-05-31, 2022-06-01_2022-10-31, 2022-11-01_2023-03-31, 2023-04-01_2023-08-28]
        data=pd.read_csv(data_root+f"tick_{stk_name}_2022-01-01_2022-05-31.csv")
        ...
        for d, g in data.groupby('date'):
            ...
            dd=g.index[0].date()
            update_date(dd.year,dd.month,dd.day)
